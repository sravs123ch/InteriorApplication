...
//     try {
//       const response = await axios.post(ForgotPassword, { Email: email });
//       console.log("Response from OTP API:", response); // Log response for debugging
//       if (response.status === 200 || response.status === 201) {
//         console.log("OTP sent successfully", response);
...
//             {/* Logo */}
//             <div className="flex justify-center rounded-md mb-8">
//               <img alt="Your Company" src={Logo} className="h-20 w-auto rounded-lg ml-6" />
//             </div>
...
//         {/* Image Section */}
//         <div className="relative hidden w-0 flex-1 lg:block h-screen">
//           <img alt="" src={image} className="absolute inset-0 h-full w-full object-cover shadow-sm" />
//         </div>
//       </div>
...
//               <button
//                 onClick={handleSubmit}
//                 className="button-login-colour w-full rounded-md px-4 py-2 text-sm font-semibold"
//               >
//                 Submit OTP
//               </button>
//             </div>
...
//                 <button
//                   onClick={handleResendOtp}
//                   className="text-sm text-[#c95d1e] underline"
//                 >
//                   Resend OTP
//                 </button>
//               ) : (
