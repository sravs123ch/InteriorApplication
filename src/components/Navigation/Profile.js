...
const Profile = () => {
  ...
  // const [isExpanded, setIsExpanded] = useState(storedCollapsed !== null ? storedCollapsed === 'false' : true);
  ...
  //   }
  // }, []);
  //  console.log(storedCollapsed,"storedCollapsed");
...
//           ...prevData,
//           ProfileImage: reader.result, // Update the profile image with the uploaded image
//         }));
//       };
...
{isEditing && (
  ...
  >
    <div
      ...
      onClick={() => document.getElementById('profile-upload').click()} // Triggers file input click
    >
...
//                       >
//                         <span className="text-base font-bold flex items-center justify-center leading-10">
//                           {/* + */}
