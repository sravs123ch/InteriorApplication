...
const YourComponent = ({ onBack, onNext, orderId }) => {
  ...
  const updateStepperStatus = (firstOrderStatus) => {
    ...
    const stepIndexMap = {
      ...
      "Pre-Final Measurement": 4,
      "Pre-Final Measurement  ": 4,
      "Final Measurement": 5,
      "Signup Document": 6,
      Production: 7,
      PDI: 8,
      Dispatch: 9, // If there are multiple dispatches, you can handle them accordingly
      Installation: 10,
      Completion: 11,
      Canceled: 12,
    };
                ...
                <div className="flex-col sm:flex-row  flex justify-center items-center gap-4 w-full">
                  ...
                  <Combobox value={selectedStatus} onChange={handleChanging}>
                    <div className="relative w-full sm:w-1/4">
                      <Combobox.Input
                        className={`p-1 w-full border rounded-md ${errors.OrderStatusError && !selectedStatus
                          ? "border-red-500"
                          : "border-gray-300"
                          }`}
                  ...
                  <div className=" w-full sm:w-1/4">
                    <div className="relative">
                      <input
                        ...
                        className={` p-1 pr-10 w-full border rounded-md ${errors.AssignToError && !desginerID
                          ? "border-red-500"
                          : "border-gray-300"
                          }`}
              ...
              <div className="flex flex-col  justify-center items-center  w-full">
                <div className="flex-col sm:flex-row  flex justify-center items-center gap-4 w-full">
                  ...
                  <Combobox value={selectedRole} onChange={handleRoleChanging}>
                    <div className="relative w-full sm:w-1/4">
                      <Combobox.Input
                        className={`p-1 w-full border rounded-md ${errors.UserRoleError && !formOrderDetails.RoleID
                          ? "border-red-500"
                          : "border-gray-300"
                          }`}
                        onChange={(e) => setQuery(e.target.value)}
              ...
              <div className="flex flex-col  justify-center items-center  w-full">
                <div className="flex-col sm:flex-row  flex justify-center items-center gap-4 w-full">
                  ...
                  <input
                    ...
                    className={`p-1 w-full sm:w-1/4 border rounded-md ${errors.DeliveryDateError && !formOrderDetails.DeliveryDate
                      ? "border-red-500"
                      : "border-gray-300"
                      }`}
                  />
                  ...
                  {filteredStatusList.map((status, index) => (
                    ...
                    >
                      ...
                      >
                        {/* Step Circle */}
                        <span
                          className={`mr-2 h-6 w-6 rounded-full flex items-center justify-center ${completedSteps[index]
                    ...
                    <TableRow key={index} className="hover:bg-gray-100">
                      ...
                      >
                        <div className="flex items-center justify-center flex-col relative w-full">
                          <div
                            className={`flex items-center w-full justify-between flex-col  ${status.OrderStatus === "Installation"
                              ? "flex-col "
                              : "md:flex-row "
                              }`}
                          >
                            ...
                            <div className="flex-1 flex justify-end p-1">
                              {status.SubStatusId !== 0 &&
                                ...
                                (status.OrderStatus === "Revised Design" ||
                                  status.OrderStatus === "Installation") ? (
                                <span
                                  className={`${status.OrderStatus === "Revised Design"
